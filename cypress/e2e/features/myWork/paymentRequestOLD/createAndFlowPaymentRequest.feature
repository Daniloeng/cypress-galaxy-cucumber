...
@focus 
    Scenario: Create Payment Request with the following characteristics: Asset; '<type>'; '<item>'; '<supplier>'; Bank Transfer
        ...
        And Inserts the document '<document>' of type 'Nota de Crédito' and fills out the form in the sidebar to add it to the Payment Request
        ...
        When Clicks on the 'Provide Decision' button under Current Status on the Payment Request screen
        And Selects 'Accept' decision on Provide Decision in Payment Accounting
        And Clicks on 'Save' button
    ...
    Scenario: Create Payment Request with the following characteristics: Asset; Blue Prints; 59202; Camara Municipal de Sitnra; Payment Service
        ...
        When Clicks on plus button by topbar
        And Clicks on 'Add Document' button by topbar
        And Inserts the document 'BluePrints' of type 'Nota de Crédito' and fills out the form in the sidebar to add it to the Payment Request
        And Clicks on Save button on Documents sidebar
        Then The document is displayed in the list of Tax Documents
    ...
    Scenario: Create Payment Request with the following characteristics: Legal Case Instance; Custas de Parte; 103743/23.0YIPRT; André Sequeira Costa; Bank Transfer
        ...
        When Clicks on plus button by topbar
        And Clicks on 'Add Document' button by topbar
        And Inserts the document 'CustasParte' of type 'Nota de Crédito' and fills out the form in the sidebar for Tax Detail to add it to the Payment Request
        And Clicks on Save button on Documents sidebar
        Then The document is displayed in the list of Tax Documents
    ...
    Scenario: Create Payment Request with the following characteristics: Legal Case Instance; Custas Judiciais - Taxa de Justiça - Injunção; 28181/24.0YIPRT; Balcão Nacional de Injunções; Payment Service
        ...
        When Clicks on plus button by topbar
        And Clicks on 'Add Document' button by topbar
        And Inserts the document 'CustasJudiciais' of type 'Factura' and fills out the form in the sidebar for Tax Detail to add it to the Payment Request
        And Clicks on Save button on Documents sidebar
        
        When Clicks on plus button by topbar
        And Clicks on 'Add Document' button by topbar
        And Inserts the document 'CustasJudiciais' of type 'Nota de Crédito' and fills out the form in the sidebar for Tax Detail to add it to the Payment Request
        And Clicks on Save button on Documents sidebar        
    ...
    Scenario: Create Payment Request with the following characteristics: Legal Case Instance; Tax - Property Transfer; 60160/23.0YIPRT; Balcão Nacional de Injunções; Payment Service
        ...
        When Clicks on plus button by topbar
        And Clicks on 'Add Document' button by topbar
        And Inserts the document 'PropertyTransfer' of type 'Factura' and fills out the form in the sidebar for Tax Detail to add it to the Payment Request
        And Clicks on Save button on Documents sidebar

        When Clicks on plus button by topbar
        And Clicks on 'Add Document' button by topbar
        And Inserts the document 'PropertyTransfer' of type 'Nota de Crédito' and fills out the form in the sidebar for Tax Detail to add it to the Payment Request
        And Clicks on Save button on Documents sidebar
