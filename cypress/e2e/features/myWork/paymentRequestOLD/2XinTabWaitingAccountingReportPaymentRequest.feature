...
#     Scenario: Export - Create Payment Request with the following characteristics: Legal Case Instance; Custas de Parte; 103743/23.0YIPRT; André Sequeira Costa; Bank Transfer
#         When Clicks on 'Add' button in toolbar
#         And Fills in Payment Request data Legal Case Instance Payment Context Custas de Parte Payment Types
#         And Clicks on 'Save' button
#         Then The 'New Payment Request' sidebar should be closed
...
#         And Checks the Tax Documents are in the exported file with 'PaymentRequestWaitingAccountin' name
