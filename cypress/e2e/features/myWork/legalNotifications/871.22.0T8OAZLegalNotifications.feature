Feature: Legal Notifications - 871/22.0T8OAZ Legal Case Instance

    This Feature is a automated test 871/22.0T8OAZ Legal Case Instance
    ...
    Scenario: 871/22.0T8OAZ - Legal Notification
        And Fills in Payment Request data 871.22.0T8OAZ Legal Case Instance
        ...
        And Adds the 'Notificação' document of type 'Invoice' and links the Related Entity 871.22.0T8OAZ Legal Case Instance to the Payment Request
        ...
        And Clicks and Edits the Legal Details '871/22.0T8OAZ' associated with Payment Request
        And Clicks on the 'Relations' tab
        And Opens '871/22.0T8OAZ - 738282' Legal Case Instance Relations
