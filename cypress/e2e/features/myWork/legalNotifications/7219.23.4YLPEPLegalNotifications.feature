Feature: Legal Notifications - 7219/23.4YLPEP Legal Case Instance
    ...
    Scenario: 7219/23.4YLPEP - Legal Notification
        And Fills in Payment Request data 7219.23.4YLPEP Legal Case Instance
        ...
        And Adds the 'Notificação' document of type 'Invoice' and links the Related Entity '7219/23.4YLPEP' Legal Case Instance and 'Hefesto (BST XXII)' Porfolio to the Payment Request
        ...
        And Clicks and Edits the Legal Details '7219/23.4YLPEP' associated with Payment Request
        And Clicks on the 'Relations' tab
        And Opens '7219/23.4YLPEP - 663200' Legal Case Instance Relations
