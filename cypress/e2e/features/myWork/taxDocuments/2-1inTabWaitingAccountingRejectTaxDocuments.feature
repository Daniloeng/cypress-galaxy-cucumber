Feature: Tax Documents - Reject in Waiting Accounting tab on Tax Documents screen

    This Feature is a automated test to Reject in Waiting Accounting tab on Tax Documents screen
    ...
    Scenario: Provide Decision - Reject
        ...
        And Selects 'Reject' Provide Decision selects 'NOK - Context' status 2 and writes 'Provide Decision Rejected' comment on Provide Decision
