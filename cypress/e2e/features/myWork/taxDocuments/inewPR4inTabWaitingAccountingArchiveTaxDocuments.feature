# Feature: Tax Documents - Archive in Waiting Accounting tab on Tax Documents screen

#     This Feature is a automated test to Archive in Waiting Accounting tab on Tax Documents screen
...
#     Scenario: Provide Decision - Archive
...
#         And Selects 'Archive' Provide Decision and writes 'Provide Decision' comments on Provide Decision
#         And Clicks on 'Save' button
