Feature: Tax Documents - Reject to Specified Queue in Waiting Accounting tab on Tax Documents screen

    This Feature is a automated test to RReject to Specified Queue in Waiting Accounting tab on Tax Documents screen
    ...
    Scenario: Provide Decision - Reject to Specified Queue 
        ...
        And Checks if the specified queue with the 'Provide Decision Rejected' comment has been created
