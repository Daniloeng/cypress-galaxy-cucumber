Feature: Payment Request - Reject on Payment Request - Tab Waiting Accounting

    This Feature is a automated test to Reject on Payment Request  - Tab Waiting Accounting
    ...
    Scenario: Reject action - Payment Request  - Waiting Accounting
        ...
        Then The status change displays the message 'Payment Request Status changed from Payment Accounting to Rejected' on the Activity screen
