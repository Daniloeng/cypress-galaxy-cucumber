Feature: Payment Request - Actions on Payment Request  - Tab Waiting Accounting

    This Feature is a automated test to Accept, Reject and Archive actions on Payment Request  - Tab Waiting Accounting
    ...
    Scenario: Accept action - Payment Request  - Waiting Accounting
        When Clicks on the 'Provide Decision' button under Current Status on the Payment Request screen
        And Selects 'Accept' Accounting Validation and writes 'Accept - Provide Decision' comment on Provide Accounting Validation
        And Clicks on 'Save' button
        ...
        Then The status change displays the message 'Payment Request Status changed from Payment Accounting to Accounting in progres' on the Activity screen
