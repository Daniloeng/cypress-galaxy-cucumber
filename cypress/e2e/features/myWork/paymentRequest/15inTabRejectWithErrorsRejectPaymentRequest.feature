Feature: Payment Request - Reject on Payment Request - Tab Rejected/With Errors

    This Feature is a automated test to Reject on Payment Request - Tab Rejected/With Errors
