Feature: Payment Request - Accept and Account on Payment Request - Tab Waiting Accounting Validation

    This Feature is a automated test to Accept and Account actions on Payment Request  - Tab Waiting Accounting Validation
    ...
    Scenario: Accept and Account action - Payment Request  - Waiting Accounting Validation
        When Clicks on the 'Provide Validation' button under Current Status on the Payment Request screen
        And Selects 'Accept and Account' Accounting Validation and writes 'Provide Validation Decision' comment on Provide Accounting Validation
        And Clicks on 'Save' button
