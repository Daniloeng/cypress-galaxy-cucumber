Feature: Payment Request - Archive on Payment Request - Tab Waiting Accounting Validation

    This Feature is a automated test to Archive actions on Payment Request  - Tab Waiting Accounting Validation
    ...
    Scenario: Archive - Payment Request  - Waiting Accounting Validation
        When Clicks on the 'Provide Validation' button under Current Status on the Payment Request screen
        And Selects 'Archive' Accounting Validation and writes 'Provide Validation Decision' comment on Provide Accounting Validation
        And Clicks on 'Save' button
        ...
        Then The status change displays the message 'Payment Request Status changed from Accounting Validation to Archived' on the Activity screen
