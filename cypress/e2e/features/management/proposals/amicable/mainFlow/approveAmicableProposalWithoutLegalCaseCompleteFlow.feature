Feature: Complete flow for approval of Amicable Proposals without Legal Case
    As Head
    ...
    Scenario Outline: Complete flow for approval of Amicable Proposals without Legal Case with <strategyName> strategy
