Feature: Real Estate Proposal - Change the status of a Real Estate Proposal from WaitingReview to WaitingReviewAcknowledge
  As a Reviwer
  ...
  Scenario Outline: Change a Real Estate Proposal in Waiting Review to WaitingReviewAcknowledge with <strategyName> strategy
    ...
    And Delegate the season to the 'testreview3' user
