Feature: Legal Proposal - Change Legal Proposals from Waiting Decision to Draft
    As a head user
    I want to change Status a Legal Proposal from Waiting Decision to Draft

    Background: Navigate to Proposal tab

    Scenario Outline: Send to Draft a Legal Proposal in Waiting Decision Status '<strategy>' Strategy
        Given Create a Legal Proposal '<strategyId>' strategy in Waiting Decision Status with Reviewer for draft by api
